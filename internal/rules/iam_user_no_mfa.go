...
// IAMUserWithoutMFARule flags IAM users that have console access (a login
...
type IAMUserWithoutMFARule struct{}

func (r IAMUserWithoutMFARule) ID() string   { return "IAM_USER_NO_MFA" }
func (r IAMUserWithoutMFARule) Name() string { return "IAM Console User Without MFA" }
...
func (r IAMUserWithoutMFARule) Evaluate(ctx RuleContext) []models.Finding {
	...
	for _, u := range ctx.RegionData.Security.IAMUsers {
		...
		findings = append(findings, models.Finding{
			...
			ResourceType:   models.ResourceIAMUser,
			Region:         "global",
