...
// EBSGP2LegacyRule flags EBS volumes still using the legacy gp2 volume type.
...
type EBSGP2LegacyRule struct{}

func (r EBSGP2LegacyRule) ID() string   { return ebsGP2LegacyRuleID }
func (r EBSGP2LegacyRule) Name() string { return "Legacy gp2 EBS Volume" }

// Evaluate returns one Finding per gp2 volume found in ctx.RegionData.
func (r EBSGP2LegacyRule) Evaluate(ctx RuleContext) []models.Finding {
